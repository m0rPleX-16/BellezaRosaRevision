            ...
            <form action="{{ route('dashboard.payments.update', $payment) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="paymentStatusEdit" data-old-value="{{ $payment->status }}" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-600 outline-none">
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            <strong>Note:</strong> "Failed" = Payment failed or declined. "Refunded" = Payment was returned
                            to customer.
                        </p>
                    </div>

                    <div id="cancellationReasonDivEdit" class="form-group hidden">
                        <label class="block text-gray-700 font-semibold mb-2">Reason <span
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <textarea name="notes" rows="3"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-200 focus:border-blue-600 outline-none"
                            placeholder="Payment notes...">{{ $payment->notes }}</textarea>
                    </div>
                </div>
