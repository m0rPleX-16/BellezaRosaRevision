...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="card bg-blue-50">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-blue-700 text-sm">Update stock for all items used today. Add a remark for each update.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <form id="dailyUpdateForm">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex space-x-2">
                                            <select name="items[{{ $item->id }}][type]"
                                                ...
                                                <option value="add"
                                                    {{ $todayUpdate && $todayUpdate->type == 'add' ? 'selected' : '' }}>Add
                                                    (+)</option>
                                                <option value="subtract"
                                                    {{ $todayUpdate && $todayUpdate->type == 'subtract' ? 'selected' : '' }}>
                                                    Use (-)</option>
                                            </select>

                                            <input type="number" name="items[{{ $item->id }}][quantity]"
                                                class="update-quantity w-20 px-2 py-1 border border-gray-300 rounded-lg text-sm"
                                                min="1" value="{{ $todayUpdate ? $todayUpdate->quantity : '' }}"
                                                placeholder="Qty" {{ !$todayUpdate ? 'disabled' : '' }}>
                                        </div>
                                    </td>
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    <div class="flex space-x-3">
                        <button type="button" onclick="markAllUsed(1)"
                            class="px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-lg text-sm">
        ...
        <div id="removedItemsSection" class="card hidden">
            ...
            <button type="button" onclick="restoreAllRemovedItems()"
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <div class="p-6">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button id="confirmRemoveBtn" onclick="confirmRemoveItem()"
    ...
    `;
        ...
        if (typeof showToast !== 'function') {
            function showToast(message, type = 'info') {
                ...
                toast.className =
                    `fixed top-4 right-4 text-white px-4 py-2 rounded-lg shadow-lg z-50 ${colors[type] || colors.info}`;
