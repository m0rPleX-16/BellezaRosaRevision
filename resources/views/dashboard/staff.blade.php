                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="text-center bg-blue-100 rounded-lg p-2 min-w-16">
                                        <div class="font-bold text-blue-700">
                                            {{ $appointment->start_datetime->format('M j') }}</div>
                                        <div class="text-xs text-blue-600">{{ $appointment->start_datetime->format('D') }}
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <div class="text-right">
                                    <div class="font-medium text-gray-900">
                                        {{ $appointment->start_datetime->format('g:i A') }}</div>
                                    <span
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-screen overflow-y-auto">
            <div class="bg-gradient-to-r from-green-900 to-green-700 text-white p-6 rounded-t-2xl">
                <div class="flex justify-between items-center">
                    ...
                    <button onclick="closeServiceReportModal()"
                                ...
                                @foreach ($todaySchedule as $appointment)
                                    @if ($appointment->status == 'completed')
                                        <div class="mb-3 p-3 border border-gray-200 rounded-lg">
                                            ...
                                            <input type="hidden" name="completed_services[]"
            ...
            fetch('{{ route("staff.statistics") }}')
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById('monthlyCommission').textContent = '₱' + data.monthly_commission
